...
public class HttpKit {
    ...
    // httpclien http tools add by mc 2018-5-14
    ...
    public static JSONObject doGet(String url, Map<String, Object> params) {
        ...
        try {
            ...
            logger.error("do get error :{}", e.getMessage());
        }
        return JSON.parseObject(result);
    }

    /**
     * 发送 POST 请求（HTTP / HTTPS），不带输入数据
     *
     * @param apiUrl
     * @return
     */
    ...
    public static JSONObject doPost(String apiUrl, Map<String, Object> params) {
        ...
        try {
            ...
            logger.error("do post error :{}", e.getMessage());
        } finally {
            if (response != null) {
                try {
    ...
    public static JSONObject doPost(String apiUrl, Object json) {
        ...
        try {
            ...
            logger.error("do post json error :{}", e.getMessage());
        } finally {
            if (response != null) {
                try {
                    EntityUtils.consume(response.getEntity());
    ...
    private static SSLConnectionSocketFactory createSSLConnSocketFactory() {
        ...
        try {
            ...
            logger.error("ssl conn error :{}", e.getMessage());
        }
        return sslsf;
    }
