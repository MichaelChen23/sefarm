...
OrderPay.initColumn = function () {
    var columns = [
        ...
        {title: '付款银行', field: 'bankType', visible: false, align: 'center', valign: 'middle', sortable: true},
        {title: '货币种类', field: 'feeType', visible: false, align: 'center', valign: 'middle', sortable: true},
        {title: '是否关注公众号', field: 'subscribeFlag', visible: false, align: 'center', valign: 'middle', sortable: true},
        {title: '微信支付订单号', field: 'transactionId', visible: false, align: 'center', valign: 'middle', sortable: true},
